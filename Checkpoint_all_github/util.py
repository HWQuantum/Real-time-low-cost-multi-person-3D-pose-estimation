...
# 15 Neck Right Shoulder
# 16 Neck Left Shoulder 
# 35 Right Shoulder Right_elbow
# 25 Right_elbow right_wrist
# 35 Left Shoulder  Left_elbow
# 25 Left_elbow left_wrist
# 60 neck right_hip 
# 60 right_hip right_knee
# 40 right_knee right_ankle
# 60 neck left_hip
# 60 left_hip left_knoee
# 40 left_knee left_ankle
# 20 neck nose
limbName = ['Neck Right Shoulder', 'Neck Left Shoulder', 'Right Shoulder Right_elbow',\
    'Right_elbow right_wrist', 'Left Shoulder  Left_elbow', 'Left_elbow left_wrist', \
        'neck right_hip', 'right_hip right_knee', 'right_knee right_ankle', \
            'neck left_hip', 'left_hip left_knoee', 'left_knee left_ankle',\
                'neck nose' ]
limbSize = [15,15,35,25,35,25,60,60,40,60,60,40,20]
...
# neck -   left_elbow
#          
# COCO_BODY_PARTS = ['nose', 'neck','right_shoulder', 'right_elbow', 'right_wrist','left_shoulder', 
# 'left_elbow', 'left_wrist',
#                     'right_hip', 'right_knee', 'right_ankle',
#                     'left_hip', 'left_knee', 'left_ankle']
                   
LIMB_PARTS = [['neck', 'right_hip'], ['neck', 'left_hip'], ['neck','right_shoulder'], ['neck', 'left_shoulder'],\
    ['neck', 'nose'],\
...
reference_size = [6,6,2,2,3,6,6,3,3,3,3,4,5]
